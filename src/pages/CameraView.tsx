      ...
      {/* <div className="max-w-7xl mx-auto grid lg:grid-cols-[1fr_340px] gap-6"> */}
        ...
        >
          <div className="absolute top-4 left-4 z-50">
            ...
            <PageHeaders title="Camera View" subtitle="International Space Station Live Camera View" description="Watch the International Space Station in real-time through NASA's official YouTube channel." />
          </div>
